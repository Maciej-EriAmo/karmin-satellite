...
| Struktura | **C+** | `starlink_atoms.py` ~1.6k LOC — god god do pocięcia (tle/map/export/cli) |
...
|---|---------|-----------|--------|
| Q1 | Monolit `engine/starlink_atoms.py` (CLI+HTML+map+TLE) | MEDIUM | backlog Faza 4+ |
